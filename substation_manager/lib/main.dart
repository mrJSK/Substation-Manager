...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      // Use MultiProvider to allow adding more providers later if needed
      providers: [
        ChangeNotifierProvider(create: (context) => SldState()),
        // Add other providers here if your app uses them, e.g.:
        // ChangeNotifierProvider(create: (context) => AnotherStateManager()),
      ],
      child: MaterialApp(
